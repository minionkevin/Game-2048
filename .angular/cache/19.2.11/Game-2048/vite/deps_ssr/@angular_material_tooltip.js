...
var CloseScrollStrategy = class {
  ...
  enable() {
    ...
    const stream = this._scrollDispatcher.scrolled(0).pipe((0, import_operators7.filter)((scrollable) => {
...
var OverlayRef = class {
  ...
  _injector;
  _renderer;
  _backdropClick = new import_rxjs9.Subject();
  _attachments = new import_rxjs9.Subject();
  _detachments = new import_rxjs9.Subject();
  _positionStrategy;
  _scrollStrategy;
  _locationChanges = import_rxjs9.Subscription.EMPTY;
  _backdropRef = null;
  /**
  ...
  _keydownEvents = new import_rxjs9.Subject();
  /** Stream of mouse outside events dispatched to this overlay. */
  _outsidePointerEvents = new import_rxjs9.Subject();
  _renders = new import_rxjs9.Subject();
  _afterRenderRef;
  ...
  _detachContentWhenEmpty() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._renders.pipe((0, import_operators7.takeUntil)((0, import_rxjs9.merge)(this._attachments, this._detachments))).subscribe(() => {
...
var FlexibleConnectedPositionStrategy = class {
  ...
  _positionChanges = new import_rxjs9.Subject();
  /** Subscription to viewport size changes. */
  _resizeSubscription = import_rxjs9.Subscription.EMPTY;
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  _overlayRef;
  _templatePortal;
  _backdropSubscription = import_rxjs9.Subscription.EMPTY;
  _attachSubscription = import_rxjs9.Subscription.EMPTY;
  _detachSubscription = import_rxjs9.Subscription.EMPTY;
  _positionSubscription = import_rxjs9.Subscription.EMPTY;
  _offsetX;
  _offsetY;
  _position;
  ...
  attachOverlay() {
    ...
    if (this.positionChange.observers.length > 0) {
      this._positionSubscription = this._position.positionChanges.pipe((0, import_operators7.takeWhile)(() => this.positionChange.observers.length > 0)).subscribe((position) => {
...
var MatTooltip = class _MatTooltip {
  ...
  ngAfterViewInit() {
    ...
    this._setupPointerEnterEventsIfNeeded();
    this._focusMonitor.monitor(this._elementRef).pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe((origin) => {
      if (!origin) {
  ...
  show(delay = this.showDelay, origin) {
    ...
    instance.afterHidden().pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._setTooltipClass(this._tooltipClass);
    this._updateTooltipMessage();
    instance.show(delay);
  }
  ...
  _createOverlay(origin) {
    ...
    strategy.positionChanges.pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe((change) => {
    ...
    this._updatePosition(this._overlayRef);
    this._overlayRef.detachments().pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._overlayRef.outsidePointerEvents().pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe(() => this._tooltipInstance?._handleBodyInteraction());
    this._overlayRef.keydownEvents().pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe((event) => {
    ...
    if (!this._dirSubscribed) {
      ...
      this._dir.change.pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe(() => {
        if (this._overlayRef) {
          this._updatePosition(this._overlayRef);
        }
      });
...
var TooltipComponent = class _TooltipComponent {
  ...
  _onHide = new import_rxjs11.Subject();
